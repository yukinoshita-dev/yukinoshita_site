export const siteData = {
  ...
  about: `C# / .NET を中心に、業務システムの設計・開発を行っています。
後から壊れない・変更に強い設計を軸に、長期運用を見据えたシステム構築を得意としています。

AI駆動開発を取り入れ、開発効率と品質の両立を図りながら、
要件整理からアーキテクチャ設計・実装・運用まで一貫して対応可能です。

2018年から業務システム開発に従事し、自治体向けシステムや社内ツール、Excel自動化など、幅広い開発を経験しました。
要件や制約に応じた柔軟な対応を重視しています。

2024年10月にフリーランスとして独立。
現在は、本質的な課題に向き合いながら、コミュニケーションと対話を通じて認識のズレを減らし、ビジネスと技術の橋渡しを行っています。

小さな改修から新規開発まで、お気軽にご相談ください。`,
